...
const ensureProduct = async (connection, productId, userId) => {
    ...
    const [result] = await connection.query(
        'INSERT INTO products (business_id, product_name, sku, opening_stock) VALUES (?, ?, ?, 0)',
        [userId, 'Default Product', sku]
    );
    return result.insertId;
};
